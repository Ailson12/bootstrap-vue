        ...
        [
            ...
            'files' => [
                ...
                [
                    ...
                    // <!-- o valor de location eu peguei na documentacao do próprio yajra datatable/documents/tutorial. Obs: vem sem a primeira barra -->
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => '/vendor/datatables/buttons.server-side.js'
                ],
                // <!-- o valor de location eu peguei em 'DataTable CDN' no tópico 'Buttons' -->
                [
                    'type' => 'css',
                    'asset' => false,
